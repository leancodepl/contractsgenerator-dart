...
- **BREAKING**: `ContractsSerializable` is no longer a `JsonSerializable` subtype. Serialization is now generated by the `contracts_serializable` builder from `package:leancode_contracts_generator` v0.19.0
